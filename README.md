...
- Timestamp: `2022-06-15 03:42`
- Build ID: `f25a4190-399a-47d9-9876-9f8777988a7e`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/f25a4190-399a-47d9-9876-9f8777988a7e.git
$ cd f25a4190-399a-47d9-9876-9f8777988a7e
```
